...
impl NativeHttp3Client {
    ...
    pub async fn new(config: super::http3_client::Http3ClientConfig) -> ServiceDiscoveryResult<Self> {
    ...
    async fn get_connection(
        ...
        let url = url::Url::parse(peer_url).map_err(|e| {
        ...
        let (mut h3_driver, h3_conn) = h3::client::new(quinn_conn).await.map_err(|e| {
            ServiceDiscoveryError::NetworkError {
