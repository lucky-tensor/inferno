...
/// `Err(InfernoError)` with detailed validation failure info.
///
/// # Performance Notes
///
...
/// # Returns
///
/// Returns `Ok(())` if validation passes, `Err(InfernoError)` otherwise
///
/// # Performance Notes
///
...
fn print_startup_info(server: &ProxyServer) {
    ...
    println!();
    println!("🚀 Inferno Proxy v{}", env!("CARGO_PKG_VERSION"));
    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    println!();
